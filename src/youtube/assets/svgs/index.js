...
class  YtHome extends Component {
    render (){
        return(
                <svg preserveAspectRatio="xMidYMid meet" focusable="false"><g >
                    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8" ></path></g></svg>          
        );
    }
}
class  YtCreate extends Component {
    render (){
        return(
...
class  YtApps extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" >
            <g>
...
class  YtNotifications extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" >
            <g >
...
class  YtHistory extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false">
                <g >
...
class  YtMyVideos extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false">
            <g>
...
class  YtWhatchLater extends Component {
    render (){
        return(
...
class  YtLikedVideos extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g >
...
class  YtListOthers extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g >
...
class  YtArrowUp extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" ><g >
            <path d="M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z" ></path></g></svg>
        );
    }
}
class  YtArrowDown extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g >
            <path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" ></path></g></svg>
        );
    }
}
class  YtPremium extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
...
class  YtFilms extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
...
class  YtFeedback extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
                <path d="M0 0h24v24H0z" fill="none" ></path><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 12h-2v-2h2v2zm0-4h-2V6h2v4z" >
                </path></g></svg>
        );
    }
}
class  YtHelp extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z" ></path></g></svg>
        );
    }
}
class  YtReportLogs extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
                <path d="M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z" ></path></g></svg>
        );
    }
}
class  YtConfig extends Component {
    render (){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
...
class  YtLearn extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
...
class  YtLive extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  ><g >
...
class  YtGames extends Component {
    render (){
        return(
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"  >
            <g >
            <path d="M22,13V8l-5-3l-5,3l0,0L7,5L2,8v5l10,6L22,13z M9,11H7v2H6v-2H4v-1h2V8h1v2h2V11z M15,13 c-0.55,0-1-0.45-1-1s0.45-1,1-1s1,0.45,1,1S15.55,13,15,13z M18,11c-0.55,0-1-0.45-1-1s0.45-1,1-1s1,0.45,1,1S18.55,11,18,11z" ></path></g></svg>
        );
    }
}
class  YtFindMore extends Component {
    render (){
        return(
...
class  YtCicleMenu extends Component {
    render (){
        return(
...
class YtMediaLogo extends Component{
    render(){
        return(
            <svg viewBox="0 0 380.9 85.1" fill="">
            <path fill="#FF0000" d="M118.9 13.5c-1.4-5.2-5.5-9.3-10.7-10.7C98.7.3 60.7.3 60.7.3s-38 0-47.5 2.5C8 4.2 3.9 8.3 2.5 13.5 0 23 0 42.7 0 42.7s0 19.8 2.5 29.2c1.4 5.2 5.5 9.3 10.7 10.7 9.5 2.5 47.5 2.5 47.5 2.5s38 0 47.5-2.5c5.2-1.4 9.3-5.5 10.7-10.7 2.5-9.5 2.5-29.2 2.5-29.2s0-19.7-2.5-29.2z"></path>
            <path fill="#FFF" d="M48.5 61l31.6-18.2-31.6-18.3z"></path>
...
class YtMenuHamburger extends Component{
    render(){
        return(
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g >
...
class YtLibraryMedia extends Component{
    render(){
        return(
            <svg viewBox="0 0 24 24" fill="">
...
class  YtLogo extends Component {
    render (){
        return(
           <svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false"  style={{pointerEvents: "none", display: "block"}}>
...
class YtFireTrending extends Component{
                render(){
                    return(
                        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false">
                        <g>
...
class YtSubscriptions extends Component{
                render(){
                    return(
                            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <g >
...
class YtLibrary extends Component{
                render(){
                    return(
                        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false">
                        <g>
                        <path fill="none" d="M0 0h24v24H0z"></path><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12.5v-9l6 4.5-6 4.5z">
                        </path>
                        </g>
                        </svg>
                          )
...
export{     YtLogo, YtFireTrending, YtSubscriptions,YtCreate, YtApps ,YtNotifications,YtSearch,
            YtHistory,YtMyVideos, YtLikedVideos, YtListOthers, YtWhatchLater,YtArrowDown,YtArrowUp,
            YtPremium, YtFilms, YtFeedback, YtHelp, YtReportLogs,YtConfig,YtLearn,
            YtLive, YtGames, YtFindMore, YtCicleMenu,YtMediaLogo,YtLibrary,YtHome,YtMenuHamburger,
            YtFireTrendingMedia,YtSubscriptionsMedia,YtLibraryMedia,YtArrowLeft
        };
